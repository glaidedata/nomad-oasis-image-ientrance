![docker image](https://github.com/glaidedata/nomad-oasis-image-ientrance/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/glaidedata/nomad-oasis-image-ientrance.git
    cd nomad-oasis-image-ientrance
    ```

    or

    ```sh
    curl-L -o nomad-oasis-image-ientrance.zip "https://github.com/glaidedata/nomad-oasis-image-ientrance/archive/main.zip"
    unzip nomad-oasis-image-ientrance.zip
    cd nomad-oasis-image-ientrance
    ```
...
your `docker-compose.yaml` with `ghcr.io/glaidedata/nomad-oasis-image-ientrance:main` for the services
...
```sh
docker pull ghcr.io/glaidedata/nomad-oasis-image-ientrance/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/glaidedata/nomad-oasis-image-ientrance/manifests/main": unauthorized`
